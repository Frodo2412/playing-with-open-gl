...
class gamehud
{
    ...
    square score_ = square(vector(-0.75f, -0.75f, 0.0f), vector(-0.5f, -0.75f, 0.0f), vector(-0.5f, -0.85f, 0.0f), vector(-0.75f, -0.85f, 0.0f));
    square tiempo_ = square(vector(-0.1f, -0.62f, 0.0f), vector(0.1f, -0.62f, 0.0f), vector(0.1f, -0.68f, 0.0f), vector(-0.1f, -0.68f, 0.0f));
